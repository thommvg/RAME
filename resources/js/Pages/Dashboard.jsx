            ...
            <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-24 lg:py-32 flex items-center h-96">
                <div className="max-w-2xl">
                    ...
                    <div className="mt-8">
                        <a
                            href="#Lugares"
                            className="inline-flex items-center justify-center px-5 py-3 rounded-md text-purple-900 bg-white hover:bg-gray-200 shadow-lg"
                        >
                            Explorar Lugares
                        </a>
                    </div>
                        ...
                        {lugares && lugares.length > 0 ? (
                            lugares.map((place) => (
                                ...
                                <PlaceCard
                                    key={place.id}
                                    name={place.nombre}
                                    rating={place.valoraciones?.length || 0}
                        ...
                        {restaurantes && restaurantes.length > 0 ? (
                            restaurantes.map((rest) => (
                                ...
                                <PlaceCard
                                    key={rest.id}
                                    name={rest.nombre}
                                    rating={rest.valoraciones?.length || 0}
            ...
            <div className="bg-gray-900 py-16 border-t border-purple-800">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="p-10">
                        ...
                        <textarea
                            placeholder="Mensaje"
                            className="w-full p-3 rounded bg-white text-black mb-6"
                        ></textarea>

                        <div className="text-center">

                            <button className="px-6 py-2 bg-purple-800 text-white rounded hover:bg-purple-900">
                                Enviar
                            </button>
